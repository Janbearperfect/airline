...
<body>
 <header>实时航班</header>
    <div class="box">
        ...
        <table class="table table-bordered">
			...
			<tr id="${flightScheduler.id}">
				...
				<td>
					  <button class="btn btn-primary see" data-toggle="modal" data-target=".bs-example-modal-sm">查看</button>
    ...
    <div class="modal fade bs-example-modal-sv" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form class="form-inline" style="margin-left:160px;margin-top: 20px" action="saveplanflight" id="sumbitfrom">
                        <input type="hidden" class="form-control flightId2" id="flightId" name="flightId">
                  
                    <div class="form-group">
                        <label for="exampleInputName2">航班编号</label>
                        <input type="text" class="form-control flightNumber2" id="flightNumber" name="flightNumber">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail2">飞机编号</label>
                        <input type="text" class="form-control airplane2" id="airplane" name="airplane">
                    </div>
                    <br>
                    <div style="width: 100%;height: 10px"></div>
                    <div class="form-group">
                        <label for="exampleInputEmail2">计划时间</label>
                        <input type="date" class="form-control startDate2" id="startDate" name="startDate">
                        <label for="exampleInputEmail2" style="width: 55px;text-align: center">——</label>
                        <input type="date" class="form-control endDate2" id="endDate" name="endDate">
                    </div>
                    <br>
                    <div style="width: 100%;height: 10px"></div>
                    <div class="form-group">
                        <label for="exampleInputEmail2">飞行区间</label>
                        <input type="text" class="form-control fromCity2" id="fromCity" name="fromCity">
                        <label for="exampleInputEmail2" style="width: 55px;text-align: center">——</label>
                        <input type="text" class=" form-control toCity2" id="toCity" name="toCity">
                    </div>
                    <br>
                    <div style="width: 100%;height: 10px"></div>
                    <div class="form-group">
                        <label for="exampleInputEmail2">机场区间</label>
                        <input type="text" class="form-control fromAirport2" id="fromAirport" readonly>
                        <label for="exampleInputEmail2" style="width: 55px;text-align: center">——</label>
                        <input type="text" class="form-control toAirport2" id="toAirport" readonly>
                    </div>
                    <br>
                    <div style="width: 100%;height: 10px"></div>
                    <div class="form-group">
                        <label for="exampleInputEmail2">飞行时间</label>
                        <input type="datetime_local" class="form-control departureTime2" id="departureTime" name="departureTime">
                        <label for="exampleInputEmail2" style="width: 55px;text-align: center">——</label>
                        <input type="datetime_local" class="form-control arrivalTime2" id="arrivalTime" name="arrivalTime">
                    </div>
                    <br>
                    <div style="width: 100%;height: 10px"></div>
                    <div class="form-group">
                        <label for="exampleInputEmail2" style="width: 55px;text-align: center">班期</label>
                        <input type="text" class="form-control scheduler2" id="scheduler" name="scheduler">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail2" style="width: 55px;text-align: center" >航程</label>
                        <input type="text" class="form-control sailLength2" id="sailLength" name="sailLength">
                    </div>
                    <br>
                    <div style="width: 100%;height: 10px"></div>
                        <button type="submit" class="btn btn-success sumbit" style="margin-left: 460px;margin-bottom: 20px">提交</button>
                </form>
